...
# C callbacks
integrand1_iso = scipy.LowLevelCallable.from_cython(integral, 'integrand1_iso')
integrand1_bur = scipy.LowLevelCallable.from_cython(integral, 'integrand1_bur')
integrand1_nfw = scipy.LowLevelCallable.from_cython(integral, 'integrand1_nfw')
integrand1_moo = scipy.LowLevelCallable.from_cython(integral, 'integrand1_moo')
integrand1_ein = scipy.LowLevelCallable.from_cython(integral, 'integrand1_ein')
integrand1_eib = scipy.LowLevelCallable.from_cython(integral, 'integrand1_eib')

integrand2 = scipy.LowLevelCallable.from_cython(integral, 'integrand2')
